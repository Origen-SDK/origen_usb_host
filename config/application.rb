require 'origen'
class UsbHostApplication < Origen::Application
  ...
  self.name       = 'usb_host'
  self.namespace  = 'UsbHost'
  config.name     = 'usb_host'
  config.initials = 'UsbHost'
  # Change this to point to the revision control repository for this plugin
  # config.rc_url   = "ssh://git@sw-stash.mycompany.net/myproject/usb_host.git"

  # To enable deployment of your documentation to a web server (via the 'origen web'
  # command) fill in these attributes.
  # config.web_directory = '/path/to/server/usb_host'
  # config.web_domain = 'http://origen.mycompany.net/usb_host'
